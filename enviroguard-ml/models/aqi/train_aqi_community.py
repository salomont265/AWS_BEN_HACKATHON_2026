"""
Train Prophet model for AQI prediction (Community mode)
...
# Load data
df = pd.read_csv('data/aqi_community.csv')
...
with open('models/aqi/aqi_community_model.pkl', 'wb') as f:
    pickle.dump(model, f)
print("\n✅ Model saved: models/aqi/aqi_community_model.pkl")
...
print("✅ Metrics saved: eval/aqi_community_metrics.json")
...
test_results.to_csv('outputs/aqi_community_predictions.csv', index=False)
print("✅ Test predictions saved: outputs/aqi_community_predictions.csv")
