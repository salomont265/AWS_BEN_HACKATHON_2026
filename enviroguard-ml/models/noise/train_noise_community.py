"""
Train Prophet model for Noise prediction (Community mode)
...
# Load data
df = pd.read_csv('data/noise_community.csv')
...
# Fit model
print("\nTraining Noise Community model...")
...
with open('models/noise/noise_community_model.pkl', 'wb') as f:
    pickle.dump(model, f)
print("\n✅ Model saved: models/noise/noise_community_model.pkl")
...
print("✅ Metrics saved: eval/noise_community_metrics.json")
...
test_results.to_csv('outputs/noise_community_predictions.csv', index=False)
print("✅ Test predictions saved: outputs/noise_community_predictions.csv")
