"""
Train Prophet model for Litter prediction (Community mode)
...
# Load data
df = pd.read_csv('data/litter_community.csv')
...
# Fit model
print("\nTraining Litter Community model...")
...
with open('models/litter/litter_community_model.pkl', 'wb') as f:
    pickle.dump(model, f)
print("\n✅ Model saved: models/litter/litter_community_model.pkl")
...
print("✅ Metrics saved: eval/litter_community_metrics.json")
...
test_results.to_csv('outputs/litter_community_predictions.csv', index=False)
print("✅ Test predictions saved: outputs/litter_community_predictions.csv")
